...
CXHMS (CX-O History & Memory Service) 是一个智能记忆管理平台，提供完整的长期记忆存储、语义搜索、自动归档、多模型对话、ACP协议通信和工具调用功能。

## 📊 项目概览

| 项目 | 说明 |
|------|------|
| **项目名称** | CXHMS (晨曦人格化记忆系统) |
| **版本** | v1.0.0 |
| **架构** | 前后端分离 (B/S 架构) |
| **许可证** | MIT License |
| **最后更新** | 2026-02-12 |
...
| Pydantic | 2.5.0+ | 数据验证 |
| SQLAlchemy | - | ORM |
| Milvus Lite | 2.3.3+ | 向量存储 |
| Qdrant Client | 1.6.9+ | 向量存储 |
| Weaviate Client | 4.0.0+ | 向量存储 |
| OpenAI SDK | 1.3.6+ | LLM 集成 |
| Anthropic | 0.7.8+ | LLM 集成 |
| Gradio | 4.7.1+ | WebUI |
| Pytest | - | 测试框架 |
...
| [PROJECT_REPORT.md](PROJECT_REPORT.md) | 项目完整报告 |
